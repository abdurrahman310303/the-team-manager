                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">{{ $stats['total_proposals'] }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <a href="{{ route('admin.overview') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded text-center">
                            <div class="text-lg">👥</div>
                            <div>Team Overview</div>
                            <div class="text-sm opacity-75">View all team details</div>
                        </a>
                        <a href="{{ route('admin.users.index') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-6 rounded text-center">
                            <div class="text-lg">👤</div>
                            <div>Manage Users</div>
                            <div class="text-sm opacity-75">Create & edit users</div>
                        </a>
                        <a href="{{ route('projects.create') }}" class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-3 px-6 rounded text-center">
                            <div class="text-lg">📋</div>
                            <div>Assign Projects</div>
                            <div class="text-sm opacity-75">Create & assign projects</div>
                        </a>
                    </div>
                </div>
            </div>
