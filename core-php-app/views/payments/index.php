...
<div class="px-4 py-6 sm:px-0">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Manage employee payments and compensation.</p>
        </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <?= htmlspecialchars($payment['user_name'] ?? 'Unknown') ?>
                                </td>
                                <?php endif; ?>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full 
                                        ...
                                        switch($payment['payment_type']) {
                                            case 'salary': echo 'bg-blue-100 text-blue-800'; break;
                                            case 'bonus': echo 'bg-green-100 text-green-800'; break;
                                            case 'commission': echo 'bg-purple-100 text-purple-800'; break;
                                            case 'overtime': echo 'bg-yellow-100 text-yellow-800'; break;
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="/payments/<?= $payment['id'] ?>" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                    <?php if (isset($user) && $user['role_name'] === 'admin'): ?>
                                    <a href="/payments/<?= $payment['id'] ?>/edit" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 bg-indigo-400 rounded-full flex items-center justify-center">
                                    <span class="text-indigo-800 font-semibold text-sm">T</span>
                                </div>
                            </div>
                            <div class="ml-5 w-0 flex-1">
                                <dt class="text-sm font-medium text-indigo-800 truncate">Total</dt>
                                <dd class="text-lg font-medium text-indigo-900">$<?= number_format($totalAll, 2) ?></dd>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 bg-green-400 rounded-full flex items-center justify-center">
                                    <span class="text-green-800 font-semibold text-sm">C</span>
                                </div>
                            </div>
                            <div class="ml-5 w-0 flex-1">
                                <dt class="text-sm font-medium text-green-800 truncate">Completed</dt>
                                <dd class="text-lg font-medium text-green-900">$<?= number_format($totalCompleted, 2) ?></dd>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <div class="w-8 h-8 bg-red-400 rounded-full flex items-center justify-center">
                                    <span class="text-red-800 font-semibold text-sm">X</span>
                                </div>
                            </div>
                            <div class="ml-5 w-0 flex-1">
                                <dt class="text-sm font-medium text-red-800 truncate">Cancelled</dt>
                                <dd class="text-lg font-medium text-red-900">$<?= number_format($totalCancelled, 2) ?></dd>
                            </div>
                        </div>
                    </div>
                </div>
